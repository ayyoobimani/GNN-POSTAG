...
pos_lang_list = ["eng-x-bible-mixed"]
#, "deu-x-bible-bolsinger", "rus-x-bible-newworld", "dan-x-bible-newworld", "fin-x-bible-helfi", 'gle-x-bible', 'urd-x-bible-2007',
...
m_path = 'POSTAG_1lngs-POSFeatTruealltgts_trnsfrmrFalse6LResTrue_trainWEFalse_mskLngTrue_E1_traintgt0.85_TypchckFalse_TgBsdSlctTrue_tstamtall_eng_20220512-112227_ElyStpDlta0-GA-chnls1024_small_final_.pickle'
...
res_ = torch.load(f'/mounts/work/ayyoob/results/gnn_postag/data/{model.model_name}_th{threshold}_typchk{type_check}.torch.bin')
tag_frequencies, tag_frequencies_target, pos_node_cover_exts, pos_label_exts, tag_based_stats = res_
train_pos_node_covers_ext, train_pos_labels_ext = pos_node_cover_exts[0], pos_label_exts[0]
#tag_frequencies_source = tag_frequencies - tag_frequencies_target
...
#test_val_lang_list = pos_test_lang_list[:]
#test_val_lang_list.extend(pos_val_lang_list)
#for lang in test_val_lang_list:
...
# %%
# Final bronze1 with xlmr eng lang
importlib.reload(posutil)
XLMR = True
POSTAG = True
WORDEMBEDDING = False
testaments = 'all'
params = f'traintgt{threshold}_Typchck{type_check}_eng'
mask_language = True
gnn_dataset_train_pos_ext = create_me_a_gnn_dataset_you_stupid([ train_pos_node_covers_ext], [train_pos_labels_ext], group_size=32)
...
# model_name = create_model(gnn_dataset_train_pos, gnn_dataset_val_pos,
# train_word_embedding=False, mask_language=mask_language, use_transformers=True, tag_frequencies=True, params=params)
#model = torch.load('/mounts/work/ayyoob/models/gnn/checkpoint/postagging/POSTAG_15lngs-POSFeatTruealltgts_trnsfrmrTrue6LResFalse_trainWEFalse_mskLngTrue_E1_traintgt0.9_TypchckFalse_TgBsdSlctTrue_tstamtall_20220410-093000_ElyStpDlta0-GA-chnls1024_small_.pickle', map_location=torch.device('cpu'))
#model_name = '15langs-nopersian_posfeatFalsealltargets_transformerFalse6layresresidualFalse_trainWEFalse_maskLangTrue_epoch1__20220317-104617_earlystoppingdelta0-GA-channels512'
# model_name = model.model_name
#model.to(dev)
#model.decoder.to(dev2)
#criterion = nn.CrossEntropyLoss()
